   ...
   // #endif
    ...
    w(t){
      ...
      if(abs(a)%2==0){
        ...
        if(b==1) cout<<ct[0]<<br;
        else if((b-1)%4==1) cout<<ct[1]<<br;
        else if((b-1)%4==2){
            ll vl=(b-1)/(ll)4;
            //cout<<ct[2];
            cout<<(vl*(ll)4)+ct[2]<<br;
        }
        else if((b-1)%4==3) cout<<ct[3]<<br;
        else{
            ll vl=(b-1)/(ll)4;
            vl--;
            cout<<ct[4]-(vl*(ll)4)<<br;
        }    
         ...
         ll vl=b/(ll)4;
         if(b%4==0) cout<<ct[0]<<br;
         else if(b%4==1){
            cout<<(vl*(ll)4)+ct[1]<<br;
         }
         else if(b%4==2){
            cout<<ct[2]<<br;
         }
         else cout<<ct[3]-(vl*(ll)4)<<br;
      }
    }
